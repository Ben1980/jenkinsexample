pipeline {
	...
	stages {
        stage('Build') {
            steps {
                cmakeBuild buildDir: 'build', buildType: 'Release', cmakeArgs: '-DCMAKE_TOOLCHAIN_FILE=/home/bmahr/Projects/vcpkg/scripts/buildsystems/vcpkg.cmake', installation: 'InSearchPath', steps: [[]]
            }
        }
